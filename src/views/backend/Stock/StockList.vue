  ...
  >
    ...
    >
      ...
      <div class="w-full h-auto mb-4">
        ...
        >
          <label class="block my-3 text-gray-700 text-md" for="car_chassis"
            >เลขตัวถัง (17 หลัก)</label
          >
          <input
            v-model="car_chassis"
          ...
          <label class="block my-3 text-gray-700 text-md" for="car_where"
            >ลานจอด</label
          >
          <select
            v-model="car_where"
          ...
          >
            ...
            <option v-for="where in where.data" :key="where.where_id">
              {{ where.car_where }}
            </option>
          </select>

          <label class="block my-3 text-gray-700 text-md" for="car_position"
            >ช่องที่จอด</label
          >
          <select
          ...
          >
            ...
            <option v-for="position in position.data" :key="position.position">
      ...
      swalWithBootstrapButtons
        ...
        .then((result) => {
          if (result.isConfirmed) {
            ...
            http
              .post(`position/${this.car_position}`, putdata)
              .then((response) => {
