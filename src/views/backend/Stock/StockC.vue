  ...
  <div
    ...
    <div>
      <p class="mb-2 text-sm font-semibold text-black dark:text-gray-400">
        Stock C (280) : ลานจอดรถ VDQi หลังกำแพง 
      </p>
      <!-- Card Lotus's -->
      <div
      ...
      <div class=" overflow-x-auto  rounded-lg dark:bg-gray-800 space-x-3 grid gap-0 mb-8 md:grid-cols-2 xl:grid-cols-1">
        <ul></ul>
        <!-- A -->
        <ul class="grid grid-cols-8 gap-4 sm:grid-cols-2 md:grid-cols-57 md:gap-12">
         <li>
